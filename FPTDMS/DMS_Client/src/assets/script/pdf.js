  ...
  return /******/ (() => {
    ...
    /******/ var __webpack_modules__ = [
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        const version = "2.15.165";
        exports.version = version;
        const build = "d72a85fa4";
        exports.build = build;
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        class AnnotationEditor {
          ...
          transform(transform) {
            ...
            const [x1, y1] = _util.Util.applyTransform(
              [this.x, this.y],
              transform
            );

            if (!Number.isNaN(width)) {
              const [x2] = _util.Util.applyTransform(
                [this.x + width, 0],
                transform
              );
            ...
            if (!Number.isNaN(height)) {
              const [, y2] = _util.Util.applyTransform(
                [0, this.y + height],
                transform
              );
        ...
        class CommandManager {
          ...
          undo() {
            ...
            if (this.#position === this.#start) {
              ...
              this.#position =
                (this.#maxSize + this.#position - 1) % this.#maxSize;
            }
          }
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        class AnnotationEditorLayer {
          ...
          static _keyboardManager = new _tools.KeyboardManager([
            [
              ["ctrl+a", "mac+meta+a"],
              AnnotationEditorLayer.prototype.selectAll,
            ],
          ...
          render(parameters) {
            ...
            this.inverseViewportTransform = _util.Util.inverseTransform(
          ...
          update(parameters) {
            const transform = _util.Util.transform(
      ...
      /***/ (__unused_webpack_module, exports, __w_pdfjs_require__) => {
        ...
        class FreeTextEditor extends _editor.AnnotationEditor {
          ...
          serialize() {
            ...
            const [x2, y2] = _util.Util.applyTransform(
      ...
      /***/ (__unused_webpack_module, exports) => {
        ...
        function generateBezier(points, parameters, leftTangent, rightTangent) {
          ...
          const segLength = maths.vectorLen(
            maths.subtract(firstPoint, lastPoint)
          );
    ...
    (() => {
      ...
      const pdfjsVersion = "2.15.165";
      const pdfjsBuild = "d72a85fa4";
      {
        if (_is_node.isNodeJS) {
